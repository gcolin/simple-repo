 ...
 * the License.
 */
package net.gcolin.simplerepo.priv;
...
import net.gcolin.simplerepo.ConfigurationManager;
import net.gcolin.simplerepo.Repository;
import net.gcolin.simplerepo.RepositoryListener;
import net.gcolin.simplerepo.Version;
...
public class RepositoryServlet extends HttpServlet implements RepositoryListener {
  ...
  public void setListeners(RepositoryListener[] listeners) {
