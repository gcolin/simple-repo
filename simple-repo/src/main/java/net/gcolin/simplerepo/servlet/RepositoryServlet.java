 ...
 * @since 1.0
 */
public class RepositoryServlet extends AbstractIoServlet implements RepositoryListener {
    ...
    public final void init() throws ServletException {
        configManager
                = (ConfigurationManager) getServletContext()
                        .getAttribute("configManager");
        List<EventListener> pluginListeners
                = (List<EventListener>) getServletContext()
                        .getAttribute("pluginListeners");
                ...
                if (c instanceof HttpURLConnection) {
                    ...
                    if (statusCode == HttpServletResponse.SC_NOT_MODIFIED) {
                        if (previous != null && previous.setLastModified(
                            ...
                            StartListener.LOG.log(Level.FINE,
                            ...
                            if (!"../".equals(name)
                                ...
                                if (name.endsWith("/")) {
                                    ...
                                    if (new File(subfile, ".todo")
                                            .createNewFile()) {
                                        StartListener.LOG.log(Level.FINER,
